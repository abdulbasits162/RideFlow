...
//         >
//           {[
//             { num: '3–5', unit: 'days', label: 'Onboarding time' },
//             { num: '15%', unit: '', label: 'Fleet commission rate' },
//             { num: '7', unit: 'days', label: 'Weekly payout cycle' },
//             { num: '2+', unit: 'vehicles', label: 'Minimum fleet size' },
//           ].map((s) => (
...
//                 {s.num}
//                 {s.unit && (
//                   <span style={{ fontSize: '0.9rem', fontWeight: 600, color: '#555', marginLeft: '0.3rem' }}>
//                     {s.unit}
//                   </span>
//                 )}
//               </div>
